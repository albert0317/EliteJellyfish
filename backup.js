...
class Music {
    ...
    /*async search (msg) {
        ...
        const musicNAME = msg.content.replace(`${prefix}play`, '').trim();
        ...
        try {
            ...
            msg.channel.send(`11`);
            const video = await yt.search(musicNAME);
...
client.on('message', async (msg) => {
    ...
    if (msg.content.indexOf(`${prefix}play`) > -1) {
        ...
        if (msg.member.voice.channel) {
            ...
            /* 
            if (msg.content.indexOf(`www.youtube.com`) > -1) {
